...
public:
    ...
    /// @brief Ищет слова в дереве и записывает их в массив tree->words
    /// @param root Корень дерева
    /// @param ind Индекс
    /// @param key Ключевое слово
    /// @param max Максимальное количество слов записываемых в tree->words, если их больше, то пропускаются.
